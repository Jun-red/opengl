...
{
	__m128 last_tmp = _mm_shuffle_ps(in[0], in[1], 0x44);
	__m128 tmp2 = _mm_shuffle_ps(in[0], in[1], 0xEE);
	__m128 cur_tmp = _mm_shuffle_ps(in[2], in[3], 0x44);
	__m128 tmp3 = _mm_shuffle_ps(in[2], in[3], 0xEE);

	out[0] = _mm_shuffle_ps(last_tmp, cur_tmp, 0x88);
	out[1] = _mm_shuffle_ps(last_tmp, cur_tmp, 0xDD);
